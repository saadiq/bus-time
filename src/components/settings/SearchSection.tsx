...
import { NearbyBusLine, BusLine } from '@/types';
import { useSettings } from '@/contexts/SettingsContext';

const SearchSection = () => {
  const {
    busLineSearch, geoLoading, geoError, showBusLineResults,
    busLineResults, onSearchChange, onInputFocus, onGeolocation,
    onSelectBusLine, onReset,
  } = useSettings();
